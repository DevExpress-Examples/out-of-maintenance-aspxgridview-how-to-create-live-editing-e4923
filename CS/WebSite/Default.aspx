...
<body>
    <form id="form1" runat="server">
        <dx:ASPxGridView ID="ASPxGridView1" runat="server" OnCommandButtonInitialize="ASPxGridView1_CommandButtonInitialize" ClientInstanceName="grid" Width="100%" SettingsEditing-NewItemRowPosition="Bottom" Theme="BlackGlass" OnDataBinding="ASPxGridView1_DataBinding" SettingsEditing-Mode="Inline" AutoGenerateColumns="False" OnRowDeleting="ASPxGridView1_RowDeleting" OnRowInserting="ASPxGridView1_RowInserting" OnRowUpdating="ASPxGridView1_RowUpdating">
            <Columns>
                <dx:GridViewCommandColumn VisibleIndex="0" Width="32" ButtonType="Image">
                    <CustomButtons>
                        <dx:GridViewCommandColumnCustomButton Image-Url="Images/update.png" ID="updateBtn" Visibility="EditableRow"></dx:GridViewCommandColumnCustomButton>
                        <dx:GridViewCommandColumnCustomButton Image-Url="Images/cancel.png" ID="cancelBtn" Visibility="EditableRow"></dx:GridViewCommandColumnCustomButton>
                        <dx:GridViewCommandColumnCustomButton Image-Url="Images/delete.png" ID="deleteBtn" Visibility="BrowsableRow"></dx:GridViewCommandColumnCustomButton>
                    </CustomButtons>
                    <NewButton Visible="true" Image-Url="Images/add.png">
                    </NewButton>
